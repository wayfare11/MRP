...
def calculate_mps(df, n, total_hours):
    ...
    for index, row in df.iterrows():
        ...
        # if safety_stock > 0:
        #     max_excess_stock = safety_stock * 10  # 允许超出安全库存的最大值
    ...
    # # 添加每个月的总工时约束
    # prob += total_hours_n >= 0.9 * total_hours[0]
    # prob += total_hours_n1 >= 0.9 * total_hours[1]
    # prob += total_hours_n2 >= 0.9 * total_hours[2]
    # prob += total_hours_n3 >= 0.9 * total_hours[3]    
